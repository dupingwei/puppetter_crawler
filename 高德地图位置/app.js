...
const getList = (item, isWW) => {
  return new Promise((resolve, reject) => {
    ...
    let urlItem = encodeURI('http://restapi.amap.com/v3/place/text?s=rsv3&children=&key=8325164e247e15eea68b59e89200988b&page=1&offset=10&city=330100&language=zh_cn&callback=jsonp_291576_&platform=JS&logversion=2.0&sdkversion=1.3&appname=http%3A%2F%2Flbs.amap.com%2Fconsole%2Fshow%2Fpicker&csid=DB516DAB-B432-47AC-AC14-08B23FF195A5&keywords=' + item)
